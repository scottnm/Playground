...
// TODO: it is not necessary to break a raw chunk for two equal pixels
// (for the matter of the resulting size)
...
TGAColor TGAImage::get_from_ratio(float x, float y) const
{
    ...
    int xi = x * width;
    int yi = y * height;
	return TGAColor(data+(xi+yi*width)*bytespp, bytespp);
}
