...
vec3 normal_shader::vertex(const mat4& viewmat, vec3 v) const
{
    auto res = viewmat * glm::vec4(v, 1);
    return res / res.w;
}

frag_color normal_shader::fragment(vec3 bary, mat3 verts, mat3x2 tex_coords, mat3 vert_norms) const
{
